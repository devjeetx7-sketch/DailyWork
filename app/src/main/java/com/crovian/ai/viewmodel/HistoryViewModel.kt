...
class HistoryViewModel : ViewModel() {
    ...
    private val _advances = MutableLiveData<List<AdvancePayment>>()
    val advances: LiveData<List<AdvancePayment>> = _advances
    ...
    fun loadMonthlyData(month: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                _advances.value = advanceRepo.getMonthlyAdvances(userId, month)
            } catch (e: Exception) {
                // handle error
            } finally {
